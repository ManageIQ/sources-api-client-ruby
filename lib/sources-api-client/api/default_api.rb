...
module SourcesApiClient
  class DefaultApi
    ...
    # @option opts [BulkCreatePayload] :bulk_create_payload 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [BulkCreatePayload] :bulk_create_payload 
    # @return [Array<(BulkCreateResponse, Integer, Hash)>] BulkCreateResponse data, response status code and response headers
    def bulk_create_with_http_info(opts = {})
    ...
    def list_all_app_meta_data(opts = {})
      data, _status_code, _headers = list_all_app_meta_data_with_http_info(opts)
      data
    end
    ...
    # @option opts [Object] :filter Filter for querying collections.
    # @option opts [Object] :sort_by The list of attribute and order to sort the result set by.
    # @return [Array<(AppMetaDataCollection, Integer, Hash)>] AppMetaDataCollection data, response status code and response headers
    def list_all_app_meta_data_with_http_info(opts = {})
      if @api_client.config.debugging
    ...
    # @option opts [Object] :sort_by The list of attribute and order to sort the result set by.
    # @return [AppMetaDataCollection]
    def list_application_type_app_meta_data(id, opts = {})
      data, _status_code, _headers = list_application_type_app_meta_data_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Object] :sort_by The list of attribute and order to sort the result set by.
    # @return [Array<(AppMetaDataCollection, Integer, Hash)>] AppMetaDataCollection data, response status code and response headers
    def list_application_type_app_meta_data_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DefaultApi.list_application_type_app_meta_data ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DefaultApi.list_application_type_app_meta_data"
      end
      pattern = Regexp.new(/^\d+$/)
      if @api_client.config.client_side_validation && id !~ pattern
        fail ArgumentError, "invalid value for 'id' when calling DefaultApi.list_application_type_app_meta_data, must conform to the pattern #{pattern}."
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling DefaultApi.list_application_type_app_meta_data, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling DefaultApi.list_application_type_app_meta_data, must be greater than or equal to 1.'
      end

      if @api_client.config.client_side_validation && !opts[:'offset'].nil? && opts[:'offset'] < 0
        fail ArgumentError, 'invalid value for "opts[:"offset"]" when calling DefaultApi.list_application_type_app_meta_data, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/application_types/{id}/app_meta_data'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#list_application_type_app_meta_data\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Object] :sort_by The list of attribute and order to sort the result set by.
    # @return [AuthenticationsCollection]
    def list_source_authentications(id, opts = {})
      data, _status_code, _headers = list_source_authentications_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Object] :sort_by The list of attribute and order to sort the result set by.
    # @return [Array<(AuthenticationsCollection, Integer, Hash)>] AuthenticationsCollection data, response status code and response headers
    def list_source_authentications_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DefaultApi.list_source_authentications ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DefaultApi.list_source_authentications"
      end
      pattern = Regexp.new(/^\d+$/)
      if @api_client.config.client_side_validation && id !~ pattern
        fail ArgumentError, "invalid value for 'id' when calling DefaultApi.list_source_authentications, must conform to the pattern #{pattern}."
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling DefaultApi.list_source_authentications, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling DefaultApi.list_source_authentications, must be greater than or equal to 1.'
      end

      if @api_client.config.client_side_validation && !opts[:'offset'].nil? && opts[:'offset'] < 0
        fail ArgumentError, 'invalid value for "opts[:"offset"]" when calling DefaultApi.list_source_authentications, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/sources/{id}/authentications'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#list_source_authentications\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [AppMetaData]
    def show_app_meta_data(id, opts = {})
      data, _status_code, _headers = show_app_meta_data_with_http_info(id, opts)
      data
    end
    ...
    # @param id [String] ID of the resource
    # @param [Hash] opts the optional parameters
    # @return [Array<(AppMetaData, Integer, Hash)>] AppMetaData data, response status code and response headers
    def show_app_meta_data_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DefaultApi.show_app_meta_data ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DefaultApi.show_app_meta_data"
      end
      pattern = Regexp.new(/^\d+$/)
      if @api_client.config.client_side_validation && id !~ pattern
        fail ArgumentError, "invalid value for 'id' when calling DefaultApi.show_app_meta_data, must conform to the pattern #{pattern}."
      end

      # resource path
      local_var_path = '/app_meta_data/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:return_type] || 'AppMetaData' 
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#show_app_meta_data\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
