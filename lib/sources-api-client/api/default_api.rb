  ...
  class DefaultApi
    ...
    def delete_application_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id !~ Regexp.new(/^\d+$/)
        fail ArgumentError, "invalid value for 'id' when calling DefaultApi.delete_application, must conform to the pattern /^\d+$/."
      end
    ...
    def list_application_type_sources_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id !~ Regexp.new(/^\d+$/)
        fail ArgumentError, "invalid value for 'id' when calling DefaultApi.list_application_type_sources, must conform to the pattern /^\d+$/."
      end
      ...
      # resource path
      local_var_path = '/application_types/{id}/sources'.sub('{' + 'id' + '}', id.to_s)
    ...
    # @option opts [Integer] :offset The number of items to skip before starting to collect the result set.
    # @option opts [Object] :filter Filter for querying collections.
    # @return [Array<(ApplicationTypesCollection, Fixnum, Hash)>] ApplicationTypesCollection data, response status code and response headers
    def list_application_types_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ApplicationTypesCollection')
      if @api_client.config.debugging
    ...
    # @option opts [Integer] :offset The number of items to skip before starting to collect the result set.
    # @option opts [Object] :filter Filter for querying collections.
    # @return [Array<(ApplicationsCollection, Fixnum, Hash)>] ApplicationsCollection data, response status code and response headers
    def list_applications_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ApplicationsCollection')
      if @api_client.config.debugging
    ...
    def list_endpoint_authentications_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id !~ Regexp.new(/^\d+$/)
        fail ArgumentError, "invalid value for 'id' when calling DefaultApi.list_endpoint_authentications, must conform to the pattern /^\d+$/."
      end
      ...
      # resource path
      local_var_path = '/endpoints/{id}/authentications'.sub('{' + 'id' + '}', id.to_s)
    ...
    def list_source_application_types_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id !~ Regexp.new(/^\d+$/)
        fail ArgumentError, "invalid value for 'id' when calling DefaultApi.list_source_application_types, must conform to the pattern /^\d+$/."
      end
      ...
      # resource path
      local_var_path = '/sources/{id}/application_types'.sub('{' + 'id' + '}', id.to_s)
    ...
    def list_source_applications_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id !~ Regexp.new(/^\d+$/)
        fail ArgumentError, "invalid value for 'id' when calling DefaultApi.list_source_applications, must conform to the pattern /^\d+$/."
      end
      ...
      # resource path
      local_var_path = '/sources/{id}/applications'.sub('{' + 'id' + '}', id.to_s)
    ...
    def show_application_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id !~ Regexp.new(/^\d+$/)
        fail ArgumentError, "invalid value for 'id' when calling DefaultApi.show_application, must conform to the pattern /^\d+$/."
      end
    ...
    # @param id ID of the resource
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplicationType, Fixnum, Hash)>] ApplicationType data, response status code and response headers
    def show_application_type_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id !~ Regexp.new(/^\d+$/)
        fail ArgumentError, "invalid value for 'id' when calling DefaultApi.show_application_type, must conform to the pattern /^\d+$/."
      end

      # resource path
      local_var_path = '/application_types/{id}'.sub('{' + 'id' + '}', id.to_s)
