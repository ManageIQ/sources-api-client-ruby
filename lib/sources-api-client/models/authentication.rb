...
module SourcesApiClient
  class Authentication
    ...
    def hash
      [authtype, availability_status, availability_status_error, extra, id, last_available_at, last_checked_at, name, password, resource_id, resource_type, source_id, username].hash
    end
