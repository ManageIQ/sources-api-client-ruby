...
# Unit tests for SourcesApiClient::OrderParameters
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OrderParameters' do
  before do
    # run before each test
    @instance = SourcesApiClient::OrderParameters.new
  end
  ...
  describe 'test an instance of OrderParameters' do
    it 'should create an instance of OrderParameters' do
      expect(@instance).to be_instance_of(SourcesApiClient::OrderParameters)
    end
  end
